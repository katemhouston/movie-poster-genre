...
parser.add_argument("--save_dir", type=str, required=True, help="Where to save images")
parser.add_argument("--metadata_path", type=str, required=True, help="Where to save metadata CSV")
...
for i, example in enumerate(ds):
    ...
    img_path = os.path.join(args.save_dir, f'{saved_idx}.jpg')
    ...
    if saved_idx % 1000 == 0:
        pd.DataFrame(rows).to_csv(args.metadata_path, index=False)
